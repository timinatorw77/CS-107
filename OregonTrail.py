...
print("From reports you have heard on the radio, you know that they worship battle and thrive on violence")
print("They surround you, and one massive man steps out from a car to fight you. What do you do?")
bandits = True
while(bandits == True):
